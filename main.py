...
class LyricsApp:
    ...
    def __init__(self, root):
        ...
        self.canvas = Canvas(mainframe, width=400, height=200)
        self.canvas.grid(column=0, row=0, columnspan=4, sticky="nsew")
        self.quote_s = self.canvas.create_text(100,100,text='placeholder', width=50,font='Arial')
        ttk.Button(mainframe, text='Generate', command=self.the_quote).grid(column=3,row=3,sticky=W)
